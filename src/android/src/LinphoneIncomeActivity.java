 ...
 */
public class LinphoneIncomeActivity extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        LinphoneCall call = Linphone.mInstance.mLinphoneCore.getCurrentCall();
        if(call != null){
            call.enableCamera(true);
            LinphoneCallParams params = Linphone.mInstance.mLinphoneManager.getLc().createCallParams(Linphone.mInstance.mLinphoneCore.getCurrentCall());
            params.setVideoEnabled(true);

            try{
                Linphone.mInstance.mLinphoneCore.acceptCallWithParams(call,params);
